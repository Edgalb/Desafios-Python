...
#o usuário tentar número inteiro entre 0 e 5 e peça para o usuário tentar descobrir qual foi o número
# escolhido pelo computador.O programa deverá escrever na tela se o usuário venceu ou perdeu.

tempo =int (input('Qual número estou pensando? '))
if tempo == 3 :
    print('Você e VITORIOSO')
else:
    print ('GAME OVER')
